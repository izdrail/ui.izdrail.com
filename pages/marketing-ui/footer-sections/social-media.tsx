...
const SocialMediaIconsFooterSection: FC = function () {
  return (
    <footer className="bg-white p-4 py-8 dark:bg-gray-800 md:p-8 lg:p-10">
          ...
          <form action="#" className="flex w-full max-w-sm lg:ml-auto">
            <div className="relative w-full">
              ...
              <input
                type="email"
                id="email"
                className="block w-full rounded-l-lg border border-gray-300 bg-gray-50 p-3 pl-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
...
export default SocialMediaIconsFooterSection;
