...
const CTASectionWithTabsAndMobileApp: FC = function () {
  return (
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
              ...
              tablist: {
                tabitem: {
                  ...
                  styles: {
                    pills: {
                      active: {
                        on: "rounded-lg bg-gray-900 text-gray-900 text-white",
                        off: "rounded-lg bg-gray-100 text-gray-500 dark:text-gray-400",
                      },
                    },
                  },
                },
          ...
          >
            <Tabs.Item
              ...
              title={
                <>
                  <span className="absolute -bottom-8 text-gray-500 dark:text-gray-400 font-medium text-base">iOS</span>
                  <svg
                    aria-hidden="true"
                    className="h-8 w-8"
...
export default CTASectionWithTabsAndMobileApp;
