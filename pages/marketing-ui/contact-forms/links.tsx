...
const ContactFormWithLinks: FC = function () {
  return (
        ...
        <div className="mb-4">
          ...
          <Select
            ...
            theme={{
              field: {
                select: {
                  base: "peer block w-full appearance-none border-0 border-b-2 border-gray-300 !bg-transparent px-0 py-2.5 text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-white dark:focus:border-blue-500",
                  withAddon: {
                    off: "rounded-none",
                  },
                },
...
export default ContactFormWithLinks;
