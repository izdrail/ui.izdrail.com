...
const ContactSectionWithBackgroundImage: FC = function () {
  return (
        ...
        <div className="space-y-8 text-center md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          ...
          <div>
            ...
            <div className="flex items-center justify-center">
              <Button outline className="[&>span]:text-primary-600 dark:[&>span]:text-primary-500">Support center</Button>
            </div>
          </div>
        </div>
      </div>
...
export default ContactSectionWithBackgroundImage;
