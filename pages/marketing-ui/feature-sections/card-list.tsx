...
const FeatureListCardsSection: FC = function () {
  return (
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-8 md:space-y-0 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
          ...
          <Card>
            ...
            <h3 className="text-xl font-bold dark:text-white">Legal</h3>
            <p className="text-gray-500 dark:text-gray-400">
          ...
          <Card>
            ...
            <h3 className="text-xl font-bold dark:text-white">Finance</h3>
            <p className="text-gray-500 dark:text-gray-400">
...
export default FeatureListCardsSection;
