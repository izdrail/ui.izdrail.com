...
const CreateFormWithAccordion: FC = function () {
  return (
            ...
            <Accordion.Panel>
              <Accordion.Title
                theme={{
                  ...
                  open: {
                    off: "bg-gray-100 border-b hover:bg-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-600",
                  },
                }}
              >
                General Information
              ...
              <Accordion.Content className="px-0">
                <div className="grid gap-4 md:gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="items-center space-y-4 w-full sm:flex sm:space-x-4 sm:space-y-0">
...
export default CreateFormWithAccordion;
