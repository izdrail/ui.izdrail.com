...
const AdvancedCreateUserForm: FC = function () {
  return (
      ...
      <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        <form>
          ...
          <div className="grid gap-4 mb-4 md:gap-6 md:grid-cols-2 sm:mb-8">
            ...
            <div>
              <Label htmlFor="job-title" className="block mb-2 dark:text-white">
                Job Title
              </Label>
              <TextInput
                id="job-title"
          ...
          <div className="grid gap-4 mb-4 md:gap-6 md:grid-cols-2 sm:mb-8">
            <div>
              <Label htmlFor="country" className="block mb-2 dark:text-white">
                Country
              </Label>
            ...
            <div>
              <Label htmlFor="timezone" className="block mb-2 dark:text-white">
                Timezone
              </Label>
              <TextInput
                id="timezone"
            ...
            <div>
              <Label htmlFor="linkedin" className="block mb-2 dark:text-white">
                Linkedin URL
              </Label>
              <TextInput
                id="linkedin"
            ...
            <div>
              <Label htmlFor="facebook" className="block mb-2 dark:text-white">
                Facebook
              </Label>
              <TextInput
                id="facebook"
            ...
            <div>
              <Label htmlFor="github" className="block mb-2 dark:text-white">
                Github
              </Label>
              <TextInput
                id="github"
            ...
            <div>
              <Label htmlFor="dribbble" className="block mb-2 dark:text-white">
                Dribbble
              </Label>
              <TextInput
                id="dribbble"
            ...
            <div>
              <Label htmlFor="instagram" className="block mb-2 dark:text-white">
                Instagram
              </Label>
              <TextInput
                id="instagram"
...
export default AdvancedCreateUserForm;
