...
import {
  ...
  HiSun,
  HiX
} from "./chunk-2HNEWVUN.js";
import {
  FaBars
} from "./chunk-YT6LDRCJ.js";
import "./chunk-JG64GGDL.js";
import {
  __commonJS,
  __toESM,
  require_react
...
var Flowbite = ({ children, theme: theme2 = {} }) => {
  ...
  const themeContextValue = (0, import_react14.useMemo)(() => ({
    theme: mergedTheme,
    mode,
    toggleMode
...
var Datepicker = ({
  ...
  const renderView = (type) => {
    switch (type) {
      case Views.Decades:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsDecades, {});
      case Views.Years:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsYears, {});
      case Views.Months:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsMonth, {});
      case Views.Days:
      default:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsDays, {});
    }
  };
  const getNextView = () => {
    switch (view) {
...
var DropdownItem = ({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  const { activeIndex, dismissOnClick, getItemProps, handleSelect } = (0, import_react19.useContext)(DropdownContext);
...
var DropdownContext = (0, import_react23.createContext)({});
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime41.jsx)("label", { className: twMerge(theme2.root.base, theme2.root.colors[color], disabled && theme2.root.disabled, className), "data-testid": "flowbite-label", ...props, children: value ?? children ?? "" });
};
...
var ListGroupItem = ({ active: isActive, children, className, href, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime42.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime42.jsxs)(Component, { href, onClick, type: isLink ? void 0 : "button", className: twMerge(theme2.link.active[isActive ? "on" : "off"], theme2.link.base, theme2.link.href[isLink ? "on" : "off"]), ...props, children: [Icon && (0, import_jsx_runtime42.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-list-group-item-icon", className: theme2.link.icon }), children] }) });
};
...
var ListGroupComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime43.jsx)("ul", { className: twMerge(theme2.root.base, className), ...props, children });
};
ListGroupComponent.displayName = "ListGroup";
ListGroupItem.displayName = "ListGroup.Item";
var ListGroup = Object.assign(ListGroupComponent, { Item: ListGroupItem });

// node_modules/flowbite-react/lib/esm/components/MegaMenu/MegaMenu.js
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime44.jsx)(Component, { className: twMerge(theme2.base, className), ...props, children });
};
...
var NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime45.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: twMerge(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime45.jsx)("ul", { className: theme2.list, children }) });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime46.jsx)("li", { children: (0, import_jsx_runtime46.jsx)(Component, { className: twMerge(theme2.base, active && theme2.active.on, !active && !disabled && theme2.active.off, theme2.disabled[disabled ? "on" : "off"], className), ...props, children }) });
};
...
var NavbarToggle = ({ barIcon: BarIcon = FaBars, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime47.jsxs)("button", { "data-testid": "flowbite-navbar-toggle", onClick: handleClick, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime47.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime47.jsx)(BarIcon, { "aria-hidden": true, className: theme2.icon })] });
};
...
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime48.jsx)(NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, import_jsx_runtime48.jsx)("nav", { className: twMerge(theme2.base, theme2.bordered[border ? "on" : "off"], theme2.rounded[rounded ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime48.jsx)("div", { className: twMerge(theme2.inner.base, theme2.inner.fluid[fluid ? "on" : "off"]), children }) }) });
};
...
// node_modules/flowbite-react/lib/esm/components/MegaMenu/MegaMenuCollapse.js
var import_jsx_runtime49 = __toESM(require_jsx_runtime());
var MegaMenuCollapse = ({ children, dropdown, ...props }) => {
  return dropdown ? (0, import_jsx_runtime49.jsx)(Dropdown, { label: dropdown, theme: {
    floating: {
      target: "!p-0 !bg-transparent !text-gray-700 !border-0 !ring-0 [&_*]:!p-0 [&>span]:items-center"
    }
  }, children }) : (0, import_jsx_runtime49.jsx)("div", { "data-testid": "flowbite-mega-menu-collapse", className: "hidden", ...props, children });
};
MegaMenuCollapse.displayName = "MegaMenu.Collapse";

// node_modules/flowbite-react/lib/esm/components/MegaMenu/MegaMenuToggle.js
var import_jsx_runtime50 = __toESM(require_jsx_runtime());
var MegaMenuToggle = ({ children, className, ...props }) => {
  const onClick = (event) => {
    const collapseButton = event.target;
    const parentMegaMenu = collapseButton.closest("nav");
    const adjacentCollapse = parentMegaMenu == null ? void 0 : parentMegaMenu.querySelector('[data-testid="flowbite-mega-menu-collapse"]');
    adjacentCollapse == null ? void 0 : adjacentCollapse.classList.toggle("hidden");
  };
  return (0, import_jsx_runtime50.jsx)(Button, { color: "gray", onClick, className: twMerge("!border-0 !bg-transparent !p-0 !text-gray-700 !ring-0 [&>span]:items-center [&_*]:!p-0", className), ...props, children });
};
MegaMenuToggle.displayName = "MegaMenu.Toggle";

// node_modules/flowbite-react/lib/esm/components/MegaMenu/MegaMenu.js
var MegaMenuComponent = ({ children, ...props }) => {
  return (0, import_jsx_runtime51.jsx)(Navbar, { ...props, children });
};
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime62.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime63.jsx)(RatingContext.Provider, { value: { size: size2 }, children: (0, import_jsx_runtime63.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const Wrapper = ({ children: children2 }) => (0, import_jsx_runtime66.jsx)("li", { children: isCollapsed && !isOpen ? (0, import_jsx_runtime66.jsx)(Tooltip, { content: label, placement: "right", children: children2 }) : children2 });
  return (0, import_jsx_runtime66.jsxs)(Wrapper, { children: [(0, import_jsx_runtime66.jsxs)("button", { id: `flowbite-sidebar-collapse-${id}`, onClick: () => setOpen(!isOpen), title: label, type: "button", className: twMerge(theme2.button, className), ...props, children: [Icon && (0, import_jsx_runtime66.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-collapse-icon", className: twMerge(theme2.icon.base, theme2.icon.open[isOpen ? "on" : "off"]) }), isCollapsed ? (0, import_jsx_runtime66.jsx)("span", { className: "sr-only", children: label }) : (0, import_jsx_runtime66.jsxs)(import_jsx_runtime66.Fragment, { children: [(0, import_jsx_runtime66.jsx)("span", { "data-testid": "flowbite-sidebar-collapse-label", className: theme2.label.base, children: label }), renderChevronIcon ? renderChevronIcon(theme2, isOpen) : (0, import_jsx_runtime66.jsx)(ChevronIcon, { "aria-hidden": true, className: twMerge(theme2.label.icon.base, theme2.label.icon.open[isOpen ? "on" : "off"]) })] })] }), (0, import_jsx_runtime66.jsx)("ul", { "aria-labelledby": `flowbite-sidebar-collapse-${id}`, hidden: !isOpen, className: theme2.list, children: (0, import_jsx_runtime66.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: true }, children }) })] });
};
...
var ListItem = ({ id, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) => (0, import_jsx_runtime67.jsx)("li", { ...props, children: isCollapsed ? (0, import_jsx_runtime67.jsx)(Tooltip, { content: (0, import_jsx_runtime67.jsx)(TooltipContent, { id, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var TooltipContent = ({ id, children }) => (0, import_jsx_runtime67.jsx)(Children4, { id, children });
var Children4 = ({ id, children }) => {
  const theme2 = useTheme().theme.sidebar.item;
  return (0, import_jsx_runtime67.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: twMerge(theme2.content.base), children });
};
var SidebarItem = (0, import_react39.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime67.jsx)(ListItem, { className: theme2.listItem, id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime67.jsxs)(Component, { "aria-labelledby": `flowbite-sidebar-item-${id}`, ref, className: twMerge(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && ((_a = theme2.collapsed) == null ? void 0 : _a.insideCollapse), className), ...props, children: [Icon && (0, import_jsx_runtime67.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-item-icon", className: twMerge((_b = theme2.icon) == null ? void 0 : _b.base, isActive && ((_c = theme2.icon) == null ? void 0 : _c.active)) }), isCollapsed && !Icon && (0, import_jsx_runtime67.jsx)("span", { className: (_d = theme2.collapsed) == null ? void 0 : _d.noIcon, children: children.charAt(0).toLocaleUpperCase() ?? "?" }), !isCollapsed && (0, import_jsx_runtime67.jsx)(Children4, { id, children }), !isCollapsed && label && (0, import_jsx_runtime67.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, className: theme2.label, children: label })] }) });
});
...
var SidebarItemGroup = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: twMerge(theme2, className), ...props, children: (0, import_jsx_runtime68.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)("div", { className: twMerge(theme2, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime70.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime70.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime70.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime71.jsx)(SidebarContext.Provider, { value: { isCollapsed }, children: (0, import_jsx_runtime71.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: twMerge(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime71.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
var Spinner = ({ className, color = "info", light, size: size2 = "md", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime72.jsx)("span", { role: "status", ...props, children: (0, import_jsx_runtime72.jsxs)("svg", { fill: "none", viewBox: "0 0 100 101", className: twMerge(theme2.base, theme2.color[color], theme2.light[light ? "on" : "off"].base, theme2.light[light ? "on" : "off"].color[color], theme2.size[size2], className), children: [(0, import_jsx_runtime72.jsx)("path", { d: "M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z", fill: "currentColor" }), (0, import_jsx_runtime72.jsx)("path", { d: "M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z", fill: "currentFill" })] }) });
};
...
var TabItem = ({ children, className }) => (0, import_jsx_runtime73.jsx)("div", { className, children });
...
var TableBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)("tbody", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime76.jsx)("td", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableHead = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime77.jsx)("thead", { className: twMerge(theme2.head.base, className), ...props, children: (0, import_jsx_runtime77.jsx)("tr", { children }) });
};
...
var TableHeadCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime78.jsx)("th", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableRow = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime79.jsx)("tr", { "data-testid": "table-row-element", className: twMerge(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = ({ children, className, hoverable, striped, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.table, customTheme);
  return (0, import_jsx_runtime80.jsx)("div", { "data-testid": "table-element", className: twMerge(theme2.root.wrapper), children: (0, import_jsx_runtime80.jsxs)(TableContext.Provider, { value: { striped, hoverable }, children: [(0, import_jsx_runtime80.jsx)("div", { className: twMerge(theme2.root.shadow, className) }), (0, import_jsx_runtime80.jsx)("table", { className: twMerge(theme2.root.base, className), ...props, children })] }) });
};
...
var TextInput = (0, import_react43.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime81.jsxs)(import_jsx_runtime81.Fragment, { children: [(0, import_jsx_runtime81.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime81.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime81.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime81.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime81.jsx)(Icon, { className: theme2.field.icon.svg }) }), RightIcon && (0, import_jsx_runtime81.jsx)("div", { "data-testid": "right-icon", className: theme2.field.rightIcon.base, children: (0, import_jsx_runtime81.jsx)(RightIcon, { className: theme2.field.rightIcon.svg }) }), (0, import_jsx_runtime81.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing], theme2.field.input.withIcon[Icon ? "on" : "off"], theme2.field.input.withRightIcon[RightIcon ? "on" : "off"], theme2.field.input.withAddon[addon ? "on" : "off"], theme2.field.input.withShadow[shadow ? "on" : "off"]), ...props, ref })] })] }), helperText && (0, import_jsx_runtime81.jsx)(HelperText, { color, children: helperText })] });
});
...
var TimelineBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime83.jsx)("div", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime84.jsx)("div", { "data-testid": "timeline-content", className: twMerge(horizontal && theme2.root.base, className), ...props, children });
};
...
var TimelineItem = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime85.jsx)("li", { "data-testid": "timeline-item", className: twMerge(horizontal && theme2.root.horizontal, !horizontal && theme2.root.vertical, className), ...props, children });
};
...
var TimelinePoint = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime86.jsxs)("div", { "data-testid": "timeline-point", className: twMerge(horizontal && theme2.horizontal, !horizontal && theme2.vertical, className), ...props, children: [children, Icon ? (0, import_jsx_runtime86.jsx)("span", { className: twMerge(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime86.jsx)(Icon, { "aria-hidden": true, className: twMerge(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime86.jsx)("div", { className: twMerge(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime86.jsx)("div", { className: twMerge(theme2.line) })] });
};
...
var TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime87.jsx)("time", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineTitle = ({ as: Tag = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime88.jsx)(Tag, { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineComponent = ({ children, className, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime89.jsx)(TimelineContext.Provider, { value: { horizontal }, children: (0, import_jsx_runtime89.jsx)("ol", { "data-testid": "timeline-component", className: twMerge(horizontal && theme2.root.direction.horizontal, !horizontal && theme2.root.direction.vertical, className), ...props, children }) });
};
...
var ToastToggle = ({ className, onClick, theme: customTheme = {}, xIcon: XIcon = HiX, onDismiss, ...props }) => {
  ...
  return (0, import_jsx_runtime90.jsx)("button", { "aria-label": "Close", onClick: handleClick, type: "button", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime90.jsx)(XIcon, { "aria-hidden": true, className: theme2.icon }) });
};
...
var ToggleSwitch = ({ checked, className, color = "blue", disabled, label, name, onChange, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime92.jsxs)(import_jsx_runtime92.Fragment, { children: [name && checked && (0, import_jsx_runtime92.jsx)("input", { checked, hidden: true, name, readOnly: true, type: "checkbox", className: "sr-only" }), (0, import_jsx_runtime92.jsxs)("button", { "aria-checked": checked, "aria-labelledby": `${id}-flowbite-toggleswitch-label`, disabled, id: `${id}-flowbite-toggleswitch`, onClick: handleClick, onKeyPress: handleKeyPress, role: "switch", tabIndex: 0, type: "button", className: twMerge(theme2.root.base, theme2.root.active[disabled ? "off" : "on"], className), ...props, children: [(0, import_jsx_runtime92.jsx)("div", { "data-testid": "flowbite-toggleswitch-toggle", className: twMerge(theme2.toggle.base, theme2.toggle.checked[checked ? "on" : "off"], !disabled && checked && theme2.toggle.checked.color[color]) }), (0, import_jsx_runtime92.jsx)("span", { "data-testid": "flowbite-toggleswitch-label", id: `${id}-flowbite-toggleswitch-label`, className: theme2.root.label, children: label })] })] });
};
...
var Floating = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: theme2, trigger = "hover", minWidth, ...props }) => {
  ...
  return (0, import_jsx_runtime93.jsxs)(import_jsx_runtime93.Fragment, { children: [(0, import_jsx_runtime93.jsx)("div", { ref: refs.setReference, className: theme2.target, "data-testid": "flowbite-tooltip-target", ...getReferenceProps(), children }), (0, import_jsx_runtime93.jsxs)("div", { ref: refs.setFloating, "data-testid": "flowbite-tooltip", ...getFloatingProps({
...
var Tooltip = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime94.jsx)(Floating, { animation, arrow: arrow3, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
